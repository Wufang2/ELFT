...
def get_args_parser():
    ...
    parser.add_argument('--config_file', '-c', type=str, default='./config/ELFT/ELFT_4scale.py')
    ...
    parser.add_argument('--note', default='/notes',
...
def main(args):
    ...
    if args.rank == 0:
        ...
        # Convert Python data structures (such as dictionaries, lists, etc.) into JSON-formatted strings, and then write them to a file or transmit them over a network.
